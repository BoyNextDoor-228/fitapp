// import 'dart:io';
//
// import 'package:app/feature/settings/domain/enum.dart';
...
//
//   group('Settings Service test. Settings very first initialization', () {
//     late bool areSettingsAbsent;
//
//     setUp(() {
//       areSettingsAbsent = settingsService.settings == null;
//     });
//
//     test('Settings are absent', () {
//       expect(areSettingsAbsent, isTrue);
//     });
//   });
//
//   group('Settings Service test. Creating new settings', () {
//     late Settings? actualSettings;
//     late Settings expectedSettings;
//
//     setUp(() async {
//       expectedSettings = const Settings(theme: AppTheme.dark);
//
